...
export async function createEventSite(props: EditEventSiteProps) {
    checkAuth(props)
...
interface EditEventSiteProps extends Partial<EventSites> {
    auth_token: string,
    event_site_id?: number,
}
export async function updateEventSite(props: EditEventSiteProps) {
    checkAuth(props)
